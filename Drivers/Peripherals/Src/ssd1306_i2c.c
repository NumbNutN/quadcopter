/*******************************************************/
/*          Driver for ssd1306 I2C interface          */
/*******************************************************/
#include "i2c.h"
...
void SSD1306_Send_Command(uint8_t cmd){
    ...
    I2C_Write((uint32_t)I2C1,SSD1306_WADDR,buf,2);
}

void SSD1306_Send_Data(uint8_t dat){
    uint8_t buf[2] = {SSD1306_DATA,dat};
    I2C_Write((uint32_t)I2C1,SSD1306_WADDR,buf,2);
}
...
void SSD1306_Init(){
    ...
    SSD1306_Send_Command(0xA1);         /* 段重定向设置 */
    SSD1306_Send_Command(0xA6);

    SSD1306_Send_Command(0xA8);         /* 设置驱动路数 */
...
void OLED_Clean(){
    uint8_t i,n;
    for(i=0;i<8;++i){
        SSD1306_Send_Command(0xB0+i);   /* 设置页地址 */
        SSD1306_Send_Command(0x00);
        SSD1306_Send_Command(0x10);
        for(n=0;n<128;n++)SSD1306_Send_Data(0);
    }
}
...
void OLED_Fill(){
    ...
    for(i=0;i<8;++i){
        ...
        SSD1306_Send_Command(0x00);
        SSD1306_Send_Command(0x10);
        for(n=0;n<128;n++)SSD1306_Send_Data(0xFF);
    }
}
/**
 * @brief 设置当前指针
