...
#define BETA 0.033
#define TASK_MAHONY_READ_PRIO 19u
#define TASK_MAHONY_PRINT_PRIO 18u
    ...
    for(;;){
        ...
        attitude = RK1(0,
                ...
                [](double t,quaternion q)->quaternion{
                        ...
                        omega_measure = accel ^ (attitude.conjugate()*earth_accel*attitude);
                        ...
                        return 0.5*q*  (last_gyro + integral_omega_measure + kp*omega_measure);
                    }).normalization();
...
{
    OSTaskCreate(TEST_Task_Print_Attitude,NULL,&Stk_PrintMahony[511],TASK_MAHONY_PRINT_PRIO);
